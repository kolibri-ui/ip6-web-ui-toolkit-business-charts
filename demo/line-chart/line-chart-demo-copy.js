...
import { dataRunningPowerPlant } from "../data-files/testDataRunningPowerPlant.mjs";
import { storagePlant }          from "../data-files/testDataStoragePlant.mjs";
import { dataNuclear }           from "../data-files/testDataNuclear.mjs";
...
const controller = LineChartController([dataRunningPowerPlant, storagePlant, dataNuclear], {
        tools: [
            zoomInTool,
            zoomOutTool,
...
const pointSizeSlider3 = document.getElementById("data-point-size-3");
pointSizeSlider3.value = Number(getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-size-3")) || 5;
pointSizeSlider3.nextElementSibling.value = pointSizeSlider3.value;
pointSizeSlider3.onchange = (_) => document.documentElement.style.setProperty("--data-point-size-3", pointSizeSlider3.value);
...
const colorPicker3 = document.getElementById("data-point-color-3");
colorPicker3.value = getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-color-3").trim();
colorPicker3.onchange = (_) => document.documentElement.style.setProperty("--data-point-color-3", colorPicker3.value);
