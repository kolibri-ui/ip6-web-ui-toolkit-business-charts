...
const controller = ScatterChartController([ dataSerie1, dataSerie2 ], {
    tools: [
        zoomInTool,
        zoomOutTool,
...
pointSizeSlider1.value
                                          = Number(getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-size-1-1"))
                                            || 5;
pointSizeSlider1.nextElementSibling.value = pointSizeSlider1.value;
pointSizeSlider1.onchange
                                          = (_) => document.documentElement.style.setProperty("--data-point-size-1-1", pointSizeSlider1.value);

const pointSizeSlider2                    = document.getElementById("data-point-size-2");
pointSizeSlider2.value
                                          = Number(getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-size-1-2"))
                                            || 5;
pointSizeSlider2.nextElementSibling.value = pointSizeSlider2.value;
pointSizeSlider2.onchange
                                          = (_) => document.documentElement.style.setProperty("--data-point-size-1-2", pointSizeSlider2.value);

const colorPicker1    = document.getElementById("data-point-color-1");
colorPicker1.value
                      = getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-color-1-1").trim();
...
colorPicker2.value
                      = getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-color-1-2").trim();
...
selectedColorPicker.value
                          = getComputedStyle(document.querySelector(".chart-canvas")).getPropertyValue("--data-point-selected-color").trim();
selectedColorPicker.onchange
                          = (_) => document.documentElement.style.setProperty("--data-point-selected-color", selectedColorPicker.value);