...
//     const root = document.createElement("container"); // created but never mounted
//     root.append(...SimpleScatterplotChart(root));
//
//     // assert properties of the generated DOM elements
//     assert.is(root.querySelectorAll("container").length, 1);
//
