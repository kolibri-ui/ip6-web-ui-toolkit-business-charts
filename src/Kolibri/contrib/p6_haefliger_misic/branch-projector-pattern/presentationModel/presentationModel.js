 ...
 * @returns {Set<string>} 
 */
const getAllUniqueGroupNames = () => allGroupNames;
...
const Attribute = value => {
  ...
  /**
   * Sets the callback function to the VALID observable, which then tests the input everytime the VALUE Observable gets
   * changed
