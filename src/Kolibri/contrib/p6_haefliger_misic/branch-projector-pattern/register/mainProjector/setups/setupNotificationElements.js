...
/**
 * Grabs all the notification elements from various projectors and binds them to their specific attributes and event
 * listeners using additional helper functions.
...
/**
 * Checks whether the email input element is valid everytime it loses focus and sets the message to the
 * EmailValidNotification Attribute accordingly.
 * @param {object} register - Holds all attributes of the register model
...
/**
 * Updates the confirmPwMatchNotification element's classes and attributes whenever the user types in the confirm
 * password input field.
 * @param {object} register - Holds all attributes of the register model
 * @param {HTMLElement} confirmPwMatchNotification - The paragraph element used to notify the user whether the confirm
 *     password he typed in matches or not
 */
