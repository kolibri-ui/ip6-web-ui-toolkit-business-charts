 ...
 * @property { ChartDataElementAndSerie } point chart data element and series
 * @property { HTMLElement }              tooltip tooltip element
 */

/**
 *
 * @param { (position: CanvasPoint2D, pointRadius: Number, title: String) => HTMLElement } tooltipProjector projector
 *     for tooltip
