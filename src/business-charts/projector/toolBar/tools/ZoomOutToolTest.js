...
import { zoomOutTool }       from "./ZoomOut.js";
...
const zoomOutToolTestSuite = TestSuite("src/business-charts/projector/toolBar/tools/ZoomOutTool");

zoomOutToolTestSuite.add("test ZoomOutTool click", assert => {
